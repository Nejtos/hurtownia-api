...
const deliveiresRowsRouter = require("./routes/DeliveriesRows");
app.use("/deliveriesrows", deliveiresRowsRouter);
...
const OrdersRowsRouter = require("./routes/OrdersRows");
app.use("/ordersrows", OrdersRowsRouter);
